...
root.title("Python Editor Developed by Abhigyan Kumar")
...
textarea = Text(
    editFrame, font=("arial", font_size, "bold"), yscrollcommand=scrollbar.set
)
...
outputarea = Text(
    outputFrame, font=("arial", font_size, "bold"), yscrollcommand=scrollbar1.set
)
